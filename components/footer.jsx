            ...
            <div className="app-footer-content-wrapper footer-top-item flex">
                <section className="app-footer-useful-link app-footer-section flex">
                    ...
                    <section className="cra-social-link-section flex">
                        <h2 className="cra-social-title">
                            CRA de l'ACEM Kénitra
                        </h2>
                        <ul className="cra-social-links-wrapper flex">
                            <li className="cra-social-link-item">
                                <Link href={craSocialLinks.facebook}>
                                    <a className="cra-social-fb a-cra-social-link">
                                        <i className="fab fa-facebook-f"></i>
                                    </a>
                                </Link>
                            </li>
                            <li className="cra-social-link-item">
                                <Link href={craSocialLinks.github}>
                                    <a className="cra-social-github a-cra-social-link">
                ...
                <section className="app-footer-github-related app-footer-section">
                    ...
                    <p className="issues-text">
                        ...
                        <Link href={craMiscLinks.githubPullIssues}>
                            <a className="issue-github">github/issues</a>
                        </Link>
                    </p>

                    <p className="pull-request-text">
                        Pour contribuer à l'amélioration du site reportez-vous
                        sur
                        <Link href={craMiscLinks.githubPullRequests}>
                            <a className="pull-request-github">
                                github/pull request
                            </a>
                        </Link>
                    </p>
